...
namespace WP8.BackgroundMusic.AudioPlaybackAgent
{
    public class AudioPlayer : AudioPlayerAgent
    {
        ...
        static AudioPlayer()
        {
            ...
            audioTrack = new AudioTrack(new Uri("01 Virtual Insanity.mp3", UriKind.Relative),
                                "01 Virtual Insanity",
                                "Jamiroquai",
            ...
            audioTrack = new AudioTrack(new Uri("02 Cosmic Girl.mp3", UriKind.Relative),
                                "02 Cosmic Girl",
                                "Jamiroquai",
                                "Travelling Without Moving",
                                null);
            ...
            audioTrack = new AudioTrack(new Uri("10 Travelling Without Moving.mp3", UriKind.Relative),
