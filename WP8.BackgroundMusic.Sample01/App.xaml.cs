...
namespace WP8.BackgroundMusic.Sample01
{
    public partial class App : Application
    {
        ...
        /// <summary>
        /// Copy app files to Isolated Storage for the Background Audio Player.
        /// </summary>
        private void CopyToIsolatedStorage()
        {
            using (IsolatedStorageFile storage = IsolatedStorageFile.GetUserStoreForApplication())
            {
                ...
                string[] files = new string[] { "01 Virtual Insanity.mp3", "02 Cosmic Girl.mp3", "10 Travelling Without Moving.mp3" };


                foreach (var strFileName in files)
                {
                    string strFilePath = "Media/Audio/" + strFileName;
